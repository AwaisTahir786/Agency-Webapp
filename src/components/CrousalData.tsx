  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-52 w-56 md:h-[30rem] md:w-[33rem] overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
