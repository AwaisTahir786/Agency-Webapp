...
export function CrousalSecond() {
  ...
  return (
    <div className="w-full h-full py-20 ">
      <h2 className=" max-w-8xl mx-auto text-xl md:text-5xl text-center font-bold text-white">
      Creative work that drives crazy results <br /> for our clients.      </h2>
    ...
    <div className='text-[#A3A3A3] text-xs text-center lg:text-sm mt-2 italic"
'>Be quick! Spots are almost gone for June.</div>
